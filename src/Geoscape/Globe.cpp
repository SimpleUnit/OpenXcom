...
{
	static inline void func(Uint8& dest, const Cord& sun, const Sint16& noise)
	{
...
void Globe::drawShadow()
{
	...
	{
		lock();
		ShaderDraw<CreateShadowFlatEarth>(ShaderSurface(this), ShaderScalar(getSunDirection(0, 0)), noise);
		unlock();
	}
	else if (Options::globeSurfaceCache)
	{
