...
private:
	...
	bool _helmet;
	int _colorPlayer, _colorHostile, _colorNeutral;
...
public:
	...
	UnitSprite(Surface* dest, const Mod* mod, const SavedBattleGame* save, int frame, bool helmet, int colorPlayer, int colorHostile, int colorNeutral);
