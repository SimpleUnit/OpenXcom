...
void createOptionsOTHER()
{
	...
	_info.push_back(OptionInfo(OPTION_OTHER, "defaultPersonalLightState", &defaultPersonalLightState, true, "STR_DEFAULT_PERSONAL_LIGHT_STATE", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo(OPTION_OTHER, "LOSequalsLOF", &LOSequalsLOF, true, "STR_LOS_EQUALS_LOF", "STR_BATTLESCAPE"));
}
...
void createControlsOTHER()
{
	...
	_info.push_back(OptionInfo(OPTION_OTHER, "keyBattlePersonalLightingUnit", &keyBattlePersonalLightingUnit, SDLK_SEMICOLON, "STR_TOGGLE_PERSONAL_LIGHTING_UNIT", "STR_BATTLESCAPE"));
